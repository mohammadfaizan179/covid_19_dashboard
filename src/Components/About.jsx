        ...
        <div className="aboutContainer" id="covid">
            ...
            <Grid container spacing={0} className="grid-wraper">
                ...
                <Grid item md={6} xs={12} className="grid-item-wraper">
                    ...
                    <br />
                    <Typography className="aboutText" variant="body1"> Most people infected with the COVID-19 virus will experience mild to moderate respiratory illness and recover without requiring special treatment.  Older people, and those with underlying medical problems like cardiovascular disease, diabetes, chronic respiratory disease, and cancer are more likely to develop serious illness.</Typography>
                    <br />
